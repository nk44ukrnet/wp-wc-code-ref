...
function fancy_lab_wc_modify()
{
    ...
    if (is_shop()) {
        add_action('woocommerce_after_main_content', 'fancy_lab_add_sidebar_tags', 6);
        function fancy_lab_add_sidebar_tags()
        {
            echo '<div class="col-lg-3 col-md-4 col-sm-12 order-2 order-md-1">';
        }

        add_action('woocommerce_after_main_content', 'woocommerce_get_sidebar', 7);
        add_action('woocommerce_after_main_content', 'fancy_lab_close_sidebar_tags', 8);
    ...
    add_action('woocommerce_after_main_content', 'fancy_lab_add_shop_tags', 9);
    function fancy_lab_add_shop_tags()
    {
        if (is_shop()) {
            echo '<div class="col-lg-9 col-md-8 col-sm-12 order-1 order-md-2">';
        } else {
            echo '<div class="col">';
        }
